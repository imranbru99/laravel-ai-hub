...
return [
    ...
    */
    'defaults' => [
        ...
        'gemini' => env('AI_HUB_GEMINI_MODEL', 'gemini-3.8-flash'),
        ...
        'openrouter' => env('AI_HUB_OPENROUTER_MODEL', 'google/gemini-3.8-flash'),
    ...
    */
    'pricing' => [
        ...
        'gemini' => [
            ...
            'gemini-3.8-flash-lite' => ['input' => 0.075, 'output' => 0.30],
        ...
        'openrouter' => [
            ...
            'google/gemini-3.8-flash' => ['input' => 0.15, 'output' => 0.60],
            'google/gemini-3.8-pro' => ['input' => 1.25, 'output' => 5.00],
        ...
        'perplexity' => [
            'sonar-deep-research' => ['input' => 5.00, 'output' => 25.00],
